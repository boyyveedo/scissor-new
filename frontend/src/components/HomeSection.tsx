        ...
        <section className="hero py-6 lg:pt-7">
            <div className='hero-inner grid gap-7 lg:gap-0 grid-cols-1 lg:grid-cols-2'>
                <picture className="hero-image flex justify-center lg:justify-start pl-6 lg:pl-0">
                    <img src={heroImage} alt="Hero" className="h-auto max-w-full" />
                </picture>
                <div className="site-desc flex flex-col justify-center gap-6 lg:gap-5 px-6 lg:px-0">
                    ...
                    <p className="subtitle text-center lg:text-left">
                        Shorten your URL for easy sharing on social media, email, text messages, <br></br>and more. Test it below and experience the convenience.</p>
